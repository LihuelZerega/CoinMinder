...
function TopFiveDollarData() {
  ...
  useEffect(() => {
    const fetchDataFromBackend = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/bcra-usdofmin");
        ...
        <div className=" py-4 px-3 rounded-md hover:bg-gray-50">
          <div className="flex flex-row items-center justify-between">
            <div className="flex flex-row items-center w-1/3">
              <p className="font-semibold">Dollar Retail</p>
            </div>
...
export default TopFiveDollarData;
