    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          className="flex flex-col text-center xl:text-start px-4 xl:px-0 py-6 xl:py-12 text-[#181818] text-sm pr-0 xl:pr-32"
        >
        ...
        <motion.div
          ...
          className="flex flex-col items-center lg:flex-row xl:flex-col 2xl:flex-row space-x-0 lg:space-x-6 xl:space-x-0 2xl:space-x-6 md:w-fit lg:w-full xl:w-full"
        >
          <motion.button
      ...
      <motion.section
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.8, delay: 0.2 }}
        className="hidden xl:flex items-start justify-end xl:w-1/2"
      >
        <motion.div
          initial={{ y: 0 }}
