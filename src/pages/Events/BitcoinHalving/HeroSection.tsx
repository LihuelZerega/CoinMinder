...
export function HeroSection() {
  ...
  return (
    <div className="h-full w-full rounded-md flex md:items-left md:justify-left bg-transparent antialiased bg-grid-white/[0.02] relative overflow-hidden">
      <div className="flex flex-row p-4 max-w-7xl mx-auto w-full pt-20 md:pt-0">
        <div className="w-2/3 space-y-8">
          <h1 className="text-4xl md:text-7xl font-bold text-left bg-clip-text text-transparent bg-gradient-to-b from-[#38bdf8] to-[#2d99c9] bg-opacity-50">
            When Is the Next <br /> Bitcoin Halving <br /> in 2024?
          </h1>
          <div className="flex flex-row">
            <CountDown />
          </div>
          <p className="max-w-xl font-normal text-base text-gray-500 text-left">
