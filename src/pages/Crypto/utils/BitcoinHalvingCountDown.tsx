...
function BitcoinHalvingCountDown() {
  ...
  return (
    <div className="flex flex-row md:flex-col items-center justify-center md:gap-2 border-t-1 mt-4">
      <section className="flex flex-row items-center md:gap-2">
        <div className="flex flex-col md:w-unit-4xl items-center py-4 px-2 md:border-solid md:border-2 md:border-sky-500 md:rounded-md">
          <h1 className="text-5xl md:text-6xl text-[#38bdf8] text-left font-sans font-medium md:font-bold">
            {countdown.days}
          </h1>
