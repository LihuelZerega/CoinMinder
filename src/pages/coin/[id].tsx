...
import BitcoinChart24hs from "../Crypto/CryptoCharts/BitcoinChart24hs";
import BitcoinChart7days from "../Crypto/CryptoCharts/BitcoinChart7days";
import BitcoinChart1month from "../Crypto/CryptoCharts/BitcoinChart1month";
import BitcoinChart3months from "../Crypto/CryptoCharts/BitcoinChart3months";
import BitcoinChart1year from "../Crypto/CryptoCharts/BitcoinChart1year";
import BitcoinChart5years from "../Crypto/CryptoCharts/BitcoinChart5years";
import BitcoinChartFullData from "../Crypto/CryptoCharts/BitcoinChartFullData";
    ...
    <div className="h-full">
      ...
      <main className="h-full mx-auto max-w-7xl px-2 sm:px-0 py-6 lg:px-8 mt-20 mb-24">
        <div className="block sm:hidden py-4">
          <Breadcrumbs>
            <BreadcrumbItem>
              <Link href="http://localhost:3000/crypto">Cryptocurrencies</Link>
            </BreadcrumbItem>
        ...
        <div className="space-y-4">
          <section className="flex flex-col sm:flex-row items-start gap-4">
                    ...
                    <Popover placement="bottom-start" showArrow={true}>
                      ...
                      <PopoverContent>
                        <div className="px-1 py-2">
                          <div className="text-tiny font-medium text-gray-400 space-y-1">
                            <h1>
                              The highest price at which a cryptocurrency has
                            </h1>
                    ...
                    <Popover placement="bottom-start" showArrow={true}>
                      ...
                      <PopoverContent>
                        <div className="px-1 py-2">
                          <div className="text-tiny font-medium text-gray-400 space-y-1">
                            <h1>
                              Market cap represents the total market value of a
                            </h1>
                            <h1>cryptocurrency's circulating supply. It is</h1>
                            <h1>
                              calculated by multiplying the current price by the
                            </h1>
                  ...
                  <div className="flex flex-row items-center space-x-1">
                    ...
                    <Popover placement="bottom-start" showArrow={true}>
                      ...
                      <PopoverContent>
                        <div className="px-1 py-2">
                          <div className="text-tiny font-medium text-gray-400 space-y-1">
                            <h1>Total volume refers to the total amount of</h1>
                            <h1>
                    ...
                    <Popover placement="bottom-start" showArrow={true}>
                      ...
                      <PopoverContent>
                        <div className="px-1 py-2">
                          <div className="text-tiny font-medium text-gray-400 space-y-1">
                            <h1>
                              Total supply refers to the total number of coins
                              or
                            </h1>
                    ...
                    <Popover placement="bottom-start" showArrow={true}>
                      ...
                      <PopoverContent>
                        <div className="px-1 py-2">
                          <div className="text-tiny font-medium text-gray-400 space-y-1">
                            <h1>
                              Max supply indicates the maximum number of coins
                              or
                            </h1>
                            <h1>tokens that will ever be created for a</h1>
                            <h1>cryptocurrency.</h1>
                  ...
                  <div className="flex flex-row items-center space-x-1">
                    ...
                    <Popover placement="bottom-start" showArrow={true}>
                      ...
                      <PopoverContent>
                        <div className="px-1 py-2">
                          <div className="text-tiny font-medium text-gray-400 space-y-1">
                            <h1>The fully diluted valuation represents the</h1>
                            <h1>theoretical market capitalization of a</h1>
                            <h1>
                              cryptocurrency if all coins were in circulation.
                            </h1>
                          </div>
                        </div>
                      </PopoverContent>
            ...
            <div className="w-full sm:w-2/3 h-full border-1 rounded-md p-4">
              ...
              <div className="flex flex-col sm:flex-row border-t-1 py-3 w-full">
                <div className="flex flex-row items-center justify-between w-full py-3 sm:py-0 border-b-1 sm:border-b-0">
                  <div className="flex flex-col items-start">
                    ...
                    <h1 className="font-semibold text-xs text-gray-600">
                      ({new Date(cryptoCurrency.ath_date).toLocaleDateString()})
                    </h1>
                  </div>
                ...
                <div className="flex flex-row items-center justify-between w-full py-3 sm:py-0 border-b-1 sm:border-b-0">
                  <div className="flex flex-col items-start">
                    ...
                    <h1 className="font-semibold text-xs text-gray-600">
                      ({new Date(cryptoCurrency.atl_date).toLocaleDateString()})
                    </h1>
                  </div>
              ...
              <div className="flex flex-row items-center justify-center border-t-1 pt-4 w-full">
                <Link href="/">
                  <h1 className="text-gray-500 text-xs hover:text-[#38bdf8] font-medium cursor-pointer">
                    All information is updated every 6 hours | Charts every 24
                    hours | Data update at 00:00 UTC.
                  </h1>
                </Link>
              </div>
            </div>
