    ...
    <div className="flex flex-col lg:flex-row w-full py-12 my-6">
      ...
      >
        <motion.div
          ...
          className="flex flex-col items-center justify-center lg:justify-start lg:items-start xl:justify-start xl:items-start  "
        >
      ...
      >
        <motion.div variants={itemVariants} className="mb-6">
          <h1 className="text-4xl lg:text-5xl xl:text-6xl 2xl:text-4xl font-bold text-[#181818]">
            Explore the latest{" "}
            <span className="text-[#fcd535]">crypto market insights</span>!
          </h1>
        </motion.div>
        ...
        >
          Stay ahead of the crypto market with our handpicked updates on
          cryptocurrencies, trends, and invaluable insights. Unlock the
          potential for profitable decisions in the world of crypto trading.
        </motion.div>
        ...
        >
          ...
          <div className="flex items-center mb-4">
            ...
            <h1 className="font-semibold">Crypto Insights & Tips</h1>
          </div>
        </motion.div>
